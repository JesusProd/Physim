...
namespace PhySim
{
	...
	public:
		...
		virtual const vector<PtrS<KinematicsEle>>& RootElements() { return this->m_vproots; }
		virtual const vector<PtrS<KinematicsEle>>& AllElements() { return this->m_vallEle; }
		virtual const vector<PtrS<KinematicsMap>>& AllMappings() { return this->m_vallMap; }
