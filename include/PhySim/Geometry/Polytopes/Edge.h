...
namespace PhySim
{
	...
	public:
		...
		* the edge is planar.
		*/
		virtual void TransformNat2Bas(VectorXd& b, MatrixXd& A, Tag s) const { throw exception("Not implemented"); }
		...
		* the edge is planar.
		*/
		virtual void TransformBas2Nat(VectorXd& b, MatrixXd& A, Tag s) const { throw exception("Not implemented"); }
