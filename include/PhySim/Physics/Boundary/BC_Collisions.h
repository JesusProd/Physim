...
namespace PhySim
{
    ...
    public:
        ...
        using ContactStorage = unordered_map<pair<Collider*, Collider*>, PtrS<ContactSet>, XorHasher>;

        using ColliderFilter = unordered_set<pair<Collider*, Collider*>, XorHasher>;

    public:
        BC_Collisions(Simulable* pSimulable, const vector<PtrS<Collider>>& vColliders);
    ...
    private:
        void DetectContacts(const PtrS<Collider_SphereCloud>& pColliderA, const PtrS<Collider_SphereCloud>& pColliderB,
                            vector<Contact>& vContactsA, vector<Contact>& vContactsB);

        void DetectContacts(const PtrS<Collider_DistanceField>& pColliderA, const PtrS<Collider_SphereCloud>& pColliderB,
                            vector<Contact>& vContactsA, vector<Contact>& vContactsB);
    ...
    public:
        ...
        void EnableCollision(const PtrS<Collider>& pColliderA, const PtrS<Collider>& pColliderB);
        void DisableCollision(const PtrS<Collider>& pColliderA, const PtrS<Collider>& pColliderB);
        bool AbleToCollide(const PtrS<Collider>& pColliderA, const PtrS<Collider>& pColliderB);

    public:
        ContactSet* Contacts(const PtrS<Collider>& pColliderA, const PtrS<Collider>& pColliderB) const;
