...
namespace PhySim
{
	...
	public:
		...
		*/
        ...
        /**
        * Defines whether the boundary condition is loaded continuously (e.g. for collisions).
        */
	...
	public:
		...
		inline const vector<PtrS<IEnergyElement>>& Energies() const override { return this->m_vpEne; }
		inline const vector<PtrS<IConstraintSet>>& Constraints() const override { return this->m_vpCon; }
		...
		inline virtual Real& MaxErrorBeforeStage() override { return m_maxErrorBeforeStage; }
        inline virtual bool& IsContinuouslyLoaded() override { return m_continuouslyLoaded; }

		inline virtual vector<VectorXd>& Values() { return this->m_vini; }

		virtual bool HasAnimator() const { return this->m_pAnimator != NULL; }

		virtual bool IsLoaded() const override { return m_continuouslyLoaded || this->m_curStage == this->m_numStage; }
		...
		virtual void GetValues(Real alpha, vector<VectorXd>& vval) 
		{
			...
			else this->m_pAnimator->Evaluate(alpha, vval);
		}
