...
class Simulable_Composite : public Simulable {
 public:
  struct DoFCoupling {
    enum Type { HardFixed, SoftFixed, HardEmbedding, SoftEmbedding, RigidBody };
 ...
 protected:
  ...
  virtual void addSoftFixedCoupling(DoFCoupling& coupling,
                                    vector<PtrS<KinematicsEle>>& vpMapped,
                                    vector<PtrS<KinematicsEle>>& vpAdded,
                                    vector<PtrS<EnergyElement>>& vpEnergy);
  virtual void addHardFixedCoupling(DoFCoupling& coupling,
                                    vector<PtrS<KinematicsEle>>& vpMapped,
                                    vector<PtrS<KinematicsEle>>& vpAdded,
                                    vector<PtrS<EnergyElement>>& vpEnergy);
  virtual void addSoftEmbeddingCoupling(DoFCoupling& coupling,
                                        vector<PtrS<KinematicsEle>>& vpMapped,
                                        vector<PtrS<KinematicsEle>>& vpAdded,
                                        vector<PtrS<EnergyElement>>& vpEnergy);
  virtual void addHardEmbeddingCoupling(DoFCoupling& coupling,
                                        vector<PtrS<KinematicsEle>>& vpMapped,
                                        vector<PtrS<KinematicsEle>>& vpAdded,
                                        vector<PtrS<EnergyElement>>& vpEnergy);
  virtual void addRigidBodyCoupling(DoFCoupling& coupling,
                                    vector<PtrS<KinematicsEle>>& vpMapped,
                                    vector<PtrS<KinematicsEle>>& vpAdded,
                                    vector<PtrS<EnergyElement>>& vpEnergy);
};
