	...
	*/
	...
	public:
		...
		*/
		...
		virtual vector<PtrS<Geometry>> Geometries() const override { return vector<PtrS<Geometry>>(); }
		...
		*/
		...
		virtual const iVector& GetSelectedElements() const { return this->m_vselEles; }
		virtual void SetSelectedElements(const iVector& vsel) { this->m_vselEles = vsel; }
		...
		virtual const vector<PtrS<IConstraintSet>>& GetConstraintSets() const { return this->m_vconsSet; }
		virtual const vector<PtrS<IEnergyElement>>& GetEnergyElements() const { return this->m_venerEle; }
		virtual const vector<PtrS<IMassElement>>& GetMassElements() const { return this->m_vmassEle; }
		...
		virtual const vector<PtrS<IBCondition>>& GetBoundaryConditions() { return this->m_vBC; }
		...
		virtual const CustomTimer& GetTimer_ComputeEnergy() const { return this->m_timerComputeEner; }
		virtual const CustomTimer& GetTimer_ComputeGradient() const { return this->m_timerComputeGrad; }
		virtual const CustomTimer& GetTimer_ComputeHessian() const { return this->m_timerComputeHess; }
		virtual const CustomTimer& GetTimer_AssembleEnergy() const { return this->m_timerAssembleEner; }
		virtual const CustomTimer& GetTimer_AssembleGradient() const { return this->m_timerAssembleGrad; }
		virtual const CustomTimer& GetTimer_AssembleHessian() const { return this->m_timerAssembleHess; }
		...
		virtual vector<IDoFSet*> SelectDoF(const Vector3d& vboxMin, const Vector3d& vboxMax, Tag s) const { return vector<IDoFSet*>(); }

	protected:

		/**
		* Frees the model data. This method frees the memory allocated to store
		* the DoF, energy elements and mass elements. Any class deriving from Simulable
		* that allocates additional memory must override this method as it is called
		* by Simulable destructor. Make sure the memory allocated by Module is also
		* freed by always calling parent FreeInternal() method.
		*/
