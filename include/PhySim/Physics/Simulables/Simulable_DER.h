...
class Simulable_DER : public Simulable_Mesh {
 ...
 public:
  ...
  virtual const vector<EnergyElement_DER_Stretch*>& GetEnergyElements_Stretch()
      const {
    return this->m_venerEle_stretch;
  }
  virtual const vector<EnergyElement_DER_BendTwist*>&
  GetEnergyElements_BendTwist() const {
    return this->m_venerEle_bendTwist;
  }
  virtual const vector<EnergyElement_DER_Connection*>&
  GetEnergyElements_Connection() const {
    return this->m_venerEle_connection;
  }
