...
namespace PhySim
{
	...
	*
	* Common interface for all FEM material models. It provides methods for computing the energy
	* density and its first derivative w.r.t. the deformation gradient (Piola stress), and its
	* second derivative w.r.t. the deformation gradient.
	*/
	...
	public:
		...
		/**
		* Returns the energy density for a given deformation gradient and material parameters.
		*/
		virtual void ComputeEnergyDensity(const ParameterSet& mat, const MatrixXd& Fm, Real& U) const = 0;

		/**
		* Returns the Piola stress for a given deformation gradient and material parameters.
		*/
		virtual void ComputePK1(const ParameterSet& mat, const MatrixXd& Fm, VectorXd& dUdF) const = 0;

		/**
		* Returns the stress derivative for a given deformation gradient and material parameters.
		*/
		virtual void ComputeDPK1DF(const ParameterSet& mat, const MatrixXd& Fv, MatrixXd& dPdF) const = 0;
	};
	...
	*/
	...
	public:
		virtual const vector<string>& GetRequiredParameters() const { return MaterialModel_3Din3D_SNH::m_vrequired; }
		...
		virtual void ComputeEnergyDensity(const ParameterSet& mat, const MatrixXd& mF, Real& U) const override
		{
			...
			U = (lame_mu / 2) * (Ic - 3) + (lame_la / 2 * (Ij - alpha) * (Ij - alpha)) - (lame_mu / 2 * std::log(Ic + 1));
		};

		virtual void ComputePK1(const ParameterSet& mat, const MatrixXd& mF, VectorXd& dUdF) const override
		{
		...
		virtual void ComputeDPK1DF(const ParameterSet& mat, const MatrixXd& mF, MatrixXd& dPdF) const override
		{
			const Matrix3r& mF3 = mF;
			...
			for (int k = 0; k < 3; ++k)
			for (int l = 0; l < 3; ++l)
				dPK1dFtensor[i][j](k,l) =
					coefs[3] * mF(i,j) * mF(k,l) +
	...
	*/
	...
	public:
		virtual const vector<string>& GetRequiredParameters() const { return MaterialModel_3Din3D_StVK::m_vrequired; }
...
#include "../Maple/FEMVol_StVK_Hessian.mcg"
	...
	*/
	...
	public:
		virtual const vector<string>& GetRequiredParameters() const { return MaterialModel_3Din3D_CoNH::m_vrequired; }
...
#include "../Maple/FEMVol_CoNH_Hessian.mcg"
	...
	*/
	...
	public:
		virtual const vector<string>& GetRequiredParameters() const { return MaterialModel_3Din3D_CoMR::m_vrequired; }
...
#include "../Maple/FEMVol_CoMR_Hessian.mcg"
	...
	*/
	...
	public:
		virtual const vector<string>& GetRequiredParameters() const { return MaterialModel_2Din3D_StVK::m_vrequired; }
...
#include "../Maple/FEMMem_StVK_Hessian.mcg"
	...
	*/
	...
	public:
		virtual const vector<string>& GetRequiredParameters() const { return MaterialModel_2Din3D_CoNH::m_vrequired; }
...
#include "../Maple/FEMMem_CoNH_Hessian.mcg"
	...
	*/
	...
	public:
		virtual const vector<string>& GetRequiredParameters() const { return MaterialModel_2Din3D_InNH::m_vrequired; }
