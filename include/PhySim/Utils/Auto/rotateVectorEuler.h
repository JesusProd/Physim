...
namespace PhySim::Utils
{ 
	void rotateVectorEuler(const double* eulerAngles, const double* vectorOriginal, double vectorRotated[3])
	{
		double t1;
		double t10;
		double t11;
		...
		vectorRotated[0] = vectorRotated[0];
		vectorRotated[1] = vectorRotated[1];
		vectorRotated[2] = vectorRotated[2];
	}
}
