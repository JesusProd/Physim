...
namespace PhySim
{
	...
	void ParameterSet::InitSNHFromYoungPoisson(Real young, Real poisson, Real density)
	{
	...
	void ParameterSet::InitLinearFromYoungPoisson(Real young, Real poisson, Real density)
	{
		this->AddParameter(Param_Young, young);
		this->AddParameter(Param_Poisson, poisson);
		this->AddParameter(Param_Density, density);
	...
	void ParameterSet::InitLinearFromLameParameters(Real lame1, Real lame2, Real density)
	{
		this->AddParameter(Param_Lame1, lame1);
		this->AddParameter(Param_Lame2, lame2);
		this->AddParameter(Param_Density, density);
