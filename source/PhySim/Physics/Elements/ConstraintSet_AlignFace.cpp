...
ConstraintSet_AlignFace::ConstraintSet_AlignFace(Simulable* pModel,
  ...
  this->m_vDoFs[0] = pFace->Nodes()[0]->Traits().Kinematics(Tag::DOF_0);
  this->m_vDoFs[1] = pFace->Nodes()[1]->Traits().Kinematics(Tag::DOF_0);
  this->m_vDoFs[2] = pFace->Nodes()[2]->Traits().Kinematics(Tag::DOF_0);
