...
namespace PhySim
{
	...
	EnergyElement_AlignNode::EnergyElement_AlignNode(Simulable* pModel, Node* pNode) : EnergyElement(pModel)
	{
	...
	void EnergyElement_AlignNode::ComputeAndStore_Energy_Internal()
	{
		...
		{
#include "../Maple/PositionAlignment_Energy.mcg";
...
#include "../Maple/PositionAlignment_Gradient.mcg";
...
#include "../Maple/PositionAlignment_Hessian.mcg";
