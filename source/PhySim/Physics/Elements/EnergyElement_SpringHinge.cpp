...
EnergyElement_SpringHinge::EnergyElement_SpringHinge(Simulable* pModel,
                                                     Edge* pEdge0,
                                                     Edge* pEdge1,
...
void EnergyElement_SpringHinge::ComputeAndStore_Energy_Internal() {
  ...
  {
#include "../include/PhySim/Utils/Auto/SpringHingeEnergy.mcg"
...
void EnergyElement_SpringHinge::ComputeAndStore_Gradient_Internal() {
  ...
  {
#include "../include/PhySim/Utils/Auto/SpringHingeGradient.mcg"
  }
...
void EnergyElement_SpringHinge::ComputeAndStore_Hessian_Internal() {
  ...
  {
#include "../include/PhySim/Utils/Auto/SpringHingeHessian.mcg"
  }
