...
EnergyElement_DiscreteShells::EnergyElement_DiscreteShells(Simulable* pModel,
                                                           Edge* pEdge)
...
void EnergyElement_DiscreteShells::ComputeAndStore_Energy_Internal() {
  ...
  {
#include "../include/PhySim/Utils/Auto/DiscreteShellsBending_Energy.mcg"
...
void EnergyElement_DiscreteShells::ComputeAndStore_Gradient_Internal() {
  ...
  {
#include "../include/PhySim/Utils/Auto/DiscreteShellsBending_Gradient.mcg"
  ...
  // pheEdge->m_pheHalf0->m_pheFace->m_pHandle->Normal(Tag_Position_X); Vector3d
  // vn1 = pheEdge->m_pheHalf1->m_pheFace->m_pHandle->Normal(Tag_Position_X);
...
#include "../include/PhySim/Utils/Auto/DiscreteShellsBending_HessianSPD.mcg"
...
Real EnergyElement_DiscreteShells::ComputeShape(Tag s) {
  ...
  {
#include "../include/PhySim/Utils/Auto/DiscreteShellsBending_Shape.mcg";

    return t46;
  }

  // Mesh_Face::HE_Edge* pheEdge =
  // this->m_pMesh->GetHEEdge(this->m_pEdge->ID()); Real A =
...
Real EnergyElement_DiscreteShells::ComputeDihedral(Tag s) {
  ...
  {
#include "../include/PhySim/Utils/Auto/DiscreteShellsBending_Dihedral.mcg";
...
Real EnergyElement_DiscreteShells::helperDistance(const Vector3d& vx,
                                                  const Vector3d& va,
                                                  const Vector3d& vb) {
  Vector3d ve = vb - va;
...
Vector2d EnergyElement_DiscreteShells::helperBarycentric(const Vector3d& vx,
                                                         const Vector3d& va,
                                                         const Vector3d& vb) {
  Vector3d ve = vb - va;
