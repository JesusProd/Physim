...
EnergyElement_SpringLinear::EnergyElement_SpringLinear(Simulable* pModel,
                                                       Edge* pEdge,
...
void EnergyElement_SpringLinear::ComputeAndStore_Hessian_Internal() {
  ...
  this->m_mHessian.block<3, 3>(0, 0) =
      k * (L0inv * ububT + s * ((mI - ububT) * Lxinv));
}

// void EnergyElement_SpringLinear::AssembleGlobal_Gradient(VectorXd&
// vtotalGradient)
//{
//	vtotalGradient.block<3, 1>(this->m_vDoF[0]->Offset(), 0) +=
//-this->m_vgradient; 	vtotalGradient.block<3, 1>(this->m_vDoF[1]->Offset(), 0)
//+= this->m_vgradient;
//}

// void EnergyElement_SpringLinear::AssembleGlobal_Hessian(VectorTd&
// vtotalHessian)
//{
...
//	if (offset0 > offset1)
//	{
//		assembleSparseMatrix(vtotalHessian, offset0, offset1,
//-m_mHessian.block<3, 3>(0, 0));
//	}
//	else
//	{
//		assembleSparseMatrix(vtotalHessian, offset1, offset0,
//-m_mHessian.block<3, 3>(0, 0));
//	}
//}
