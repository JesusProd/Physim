...
namespace PhySim
{
	...
	ConstraintSet_NodePlaneColl::ConstraintSet_NodePlaneColl(Simulable* pModel, bool isSoft, KEleParticle3D* pDOF, const Vector3d& vp, const Vector3d& vn, Real tol) : ConstraintSet(pModel, isSoft)
	{
