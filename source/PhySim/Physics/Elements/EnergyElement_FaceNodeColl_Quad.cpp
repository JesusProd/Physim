...
namespace PhySim
{
	...
	EnergyElement_FaceNodeColl_Quad::EnergyElement_FaceNodeColl_Quad(Simulable* pModel, Face* pFace, Node* pNode) : EnergyElement(pModel)
	{
	...
	{
//		const Vector3d& x0 = this->m_vDoF[0]->Geometry()->Traits().Vector3d(Tag_Position_X);
//		const Vector3d& x1 = this->m_vDoF[1]->Geometry()->Traits().Vector3d(Tag_Position_X);
//		const Vector3d& x2 = this->m_vDoF[2]->Geometry()->Traits().Vector3d(Tag_Position_X);
//		const Vector3d& x3 = this->m_vDoF[3]->Geometry()->Traits().Vector3d(Tag_Position_X);
//		Vector3d e0 = (x1 - x0).normalized();
//		Vector3d e1 = (x2 - x0).normalized();
//		Vector3d e3 = x3 - x0;
//		Real D = e0.cross(e1).dot(e3);
//		Real T = (*this->m_pMaterial)[ParameterSet::Param_CollT];
//		Real K = (*this->m_pMaterial)[ParameterSet::Param_CollK];
//		if (D > T)
//		{
//			this->m_energy = 0;
//			return; // Oneside
//		}
//
//#include "../Maple/FaceNodeCollQuad_Energy.mcg"
//
//		this->m_energy = t47;
	}
...
//		Real vgx[12];
//
//#include "../Maple/FaceNodeCollQuad_Gradient.mcg"
//
//		for (int i = 0; i < 12; ++i)
//			m_vgradient(i) = vgx[i];
	}
...
//		Real mHx[12][12];
//
//#include "../Maple/FaceNodeCollQuad_Hessian.mcg"
//
//		for (int i = 0; i < 12; ++i)
//			for (int j = 0; j < 12; ++j)
