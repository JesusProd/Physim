...
namespace PhySim
{
	...
	int KEleDERMatTwist::GetFullStateSize() const { return 11; }
	...
	int KEleDERConnRot::GetFullStateSize() const { return 15; }
	...
	int KEleDERRefTwist::GetFullStateSize() const { return 1; }
