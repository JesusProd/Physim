...
namespace PhySim
{
	...
	KinematicsTree::KinematicsTree(Simulable* pModel, vector<PtrS<KinematicsEle>>& vproots)
	{
	...
	void KinematicsTree::GetPositionX(VectorXd& vx) const
	{
		...
		for (size_t i = 0; i < numRoots; ++i)
		{
			...
			vx.segment(this->m_vproots[i]->Offset(), this->m_vproots[i]->NumDim()) = this->m_vproots[i]->GetPositionX();
		}
	}
	...
	void KinematicsTree::GetPosition0(VectorXd& v0) const
	{
		...
		for (size_t i = 0; i < numRoots; ++i)
		{
			...
			v0.segment(this->m_vproots[i]->Offset(), this->m_vproots[i]->NumDim()) = this->m_vproots[i]->GetPosition0();
		}
	}
	...
	void KinematicsTree::GetVelocity(VectorXd& vv) const
	{
		...
		for (size_t i = 0; i < numRoots; ++i)
		{
			...
			vv.segment(this->m_vproots[i]->Offset(), this->m_vproots[i]->NumDim()) = this->m_vproots[i]->GetVelocity();
		}
	}
	...
	void KinematicsTree::SetPositionX(const VectorXd& vx)
	{
		...
		for (size_t i = 0; i < numRoots; ++i)
		{
			...
			this->m_vproots[i]->SetPositionX(vx.segment(this->m_vproots[i]->Offset(), this->m_vproots[i]->NumDim()));
		}
	...
	void KinematicsTree::SetPosition0(const VectorXd& v0)
	{
		...
		for (size_t i = 0; i < numRoots; ++i)
		{
			...
			this->m_vproots[i]->SetPosition0(v0.segment(this->m_vproots[i]->Offset(), this->m_vproots[i]->NumDim()));
		}
	...
	void KinematicsTree::SetVelocity(const VectorXd& vv)
	{
		...
		for (size_t i = 0; i < numRoots; ++i)
		{
			...
			this->m_vproots[i]->SetVelocity(vv.segment(this->m_vproots[i]->Offset(), this->m_vproots[i]->NumDim()));
		}
