...
namespace PhySim
{
	...
	LSResult LinearSolver_BiCGSTAB::SolveInternal(MatrixSd& mA, const VectorXd& vb, VectorXd& vx)
	{
		MatrixSd mAFull = mA.selfadjointView<Lower>();
	...
	LSResult LinearSolver_BiCGSTAB::SolveInternal(MatrixSd& mA, const MatrixXd& mB, MatrixXd& mX)
	{
	...
	LSResult LinearSolver_BiCGSTAB::SolveInternal(MatrixSd& mA, const MatrixSd& mB, MatrixSd& mX)
	{
		throw new exception("Not implemented");
