...
void LinearSolver_SSparseSPQR::Init(const MatrixSd& mA,
                                    const LinearSolverOptions& options) {
...
SolveResult LinearSolver_SSparseSPQR::SolveInternal(MatrixSd& mA,
                                                    const VectorXd& vb,
                                                    VectorXd& vx) {
  ...
  for (i = 0; i < this->m_options.regIters; ++i) {
    ...
    //	{
    //		logTrace(Verbosity::V1_Default, "\n[FAILURE] Linear solve: singular
    //matrix, value: %.6e", vd(j)); 		jumpSin = true; 		break;
    //	}
    //}
...
// SolveResult LinearSolver_SSparseSPQR::Solve_CG(MatrixSd& mA, const VectorXd&
// vb, VectorXd& vx)
//{
//	int N;
//	Real normA;
...
// SolveResult LinearSolver_SSparseSPQR::Solve_LU(MatrixSd& mA, const VectorXd&
// vb, VectorXd& vx)
//{
//	int N;
//	Real normA;
