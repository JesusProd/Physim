...
namespace PhySim
{
	...
	Mesh_Tetra::Mesh_Tetra(const MatrixXd& mV, const MatrixXi& mC, Discretization D, const vector<Tag>& vnTraits) : Mesh_Cell(mV, mC, D, vnTraits)
	{
		this->UpdateMetadata();
	}

	void Mesh_Tetra::Init(const MatrixXd& mV, const MatrixXi& mE, Discretization D, const vector<Tag>& vnTraits)
	{
