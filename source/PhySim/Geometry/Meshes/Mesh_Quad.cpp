...
namespace PhySim
{
	...
	Mesh_Quad::Mesh_Quad(const MatrixXd& mV, const MatrixXi& mF, Discretization D, const vector<Tag>& vnTraits) : Mesh_Face(mV, mF, D, vnTraits)
	{
		this->UpdateMetadata();
	}

	void Mesh_Quad::Init(const MatrixXd& mV, const MatrixXi& mF, Discretization D, const vector<Tag>& vnTraits)
	{
