...
Mesh_Tri::Mesh_Tri(const MatrixXd& mV,
                   const MatrixXi& mF,
                   Discretization D,
...
void Mesh_Tri::Init(const MatrixXd& mV,
                    const MatrixXi& mF,
                    Discretization D,
                    const vector<Tag>& vnTraits) {
...
void Mesh_Tri::GetBoundaryCurves(vector<vector<Node*>>& vC,
                                 Real angleTol,
                                 Tag s) {
  vector<Node*> vbloop;
...
void Mesh_Tri::SkinningBiharmonic(const VectorXi& vhandles,
                                  MatrixXd& mweights,
                                  Tag s) {
  MatrixXd mV;
  MatrixXi mE;
...
void Mesh_Tri::SkinningLaplacian(const VectorXi& vhandles,
                                 MatrixXd& mweights,
                                 Tag s) {
  // TODO
}
...
void Mesh_Tri::MassProperties(Tag s,
                              Real rho,
                              Real& mass,
                              Vector3d& vcom,
                              Matrix3d& mI) const {
