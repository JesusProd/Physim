...
Cell_Tetra::Cell_Tetra(int id, const vector<Node*>& m_vnodes)
    : Cell(id, m_vnodes) {
  // Nothing to do here...
}
...
Real Cell_Tetra::VolumeSpace(Tag s) const {
  Matrix3d mV;
  mV.col(0) = this->m_vnodes[1]->Traits().Vector3d(s) -
              this->m_vnodes[0]->Traits().Vector3d(s);
  mV.col(1) = this->m_vnodes[2]->Traits().Vector3d(s) -
              this->m_vnodes[0]->Traits().Vector3d(s);
  mV.col(2) = this->m_vnodes[3]->Traits().Vector3d(s) -
              this->m_vnodes[0]->Traits().Vector3d(s);
...
void Cell_Tetra::TransformNat2Iso(VectorXd& b, MatrixXd& A, Tag s) const {
  ...
  mNB.col(0) = this->m_vnodes[1]->Traits().Vector3d(s) -
               this->m_vnodes[0]->Traits().Vector3d(s);
  mNB.col(1) = this->m_vnodes[2]->Traits().Vector3d(s) -
               this->m_vnodes[0]->Traits().Vector3d(s);
  mNB.col(2) = this->m_vnodes[3]->Traits().Vector3d(s) -
               this->m_vnodes[0]->Traits().Vector3d(s);
  A = mNB.inverse();
...
void Cell_Tetra::TransformIso2Nat(VectorXd& b, MatrixXd& A, Tag s) const {
  ...
  A.col(0) = this->m_vnodes[1]->Traits().Vector3d(s) -
             this->m_vnodes[0]->Traits().Vector3d(s);
  A.col(1) = this->m_vnodes[2]->Traits().Vector3d(s) -
             this->m_vnodes[0]->Traits().Vector3d(s);
  A.col(2) = this->m_vnodes[3]->Traits().Vector3d(s) -
             this->m_vnodes[0]->Traits().Vector3d(s);
