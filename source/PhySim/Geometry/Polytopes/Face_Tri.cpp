...
Vector3d Face_Tri::Normal(Tag s) const {
  Vector3d e0 =
      (m_vnodes[1]->Traits().Vector3d(s) - m_vnodes[0]->Traits().Vector3d(s));
  Vector3d e1 =
      (m_vnodes[2]->Traits().Vector3d(s) - m_vnodes[0]->Traits().Vector3d(s));
...
void Face_Tri::TransformNat2Iso(VectorXd& b, MatrixXd& A, Tag s) const {
  ...
  Vector3d e1 = this->m_vnodes[2]->Traits().Vector3d(s) -
                this->m_vnodes[0]->Traits().Vector3d(s);
  mNB.col(0) = e0;
  mNB.col(1) = e1;
